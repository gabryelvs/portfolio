...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Proof", value: "72 tests, 59 on real PostgreSQL (Testcontainers)" },
    ],
    stack: ["Java 21", "Spring Boot", "PostgreSQL", "Testcontainers", "Docker"],
    role: "Solo: design, build, deploy",
    tests: "72 tests (59 integration on real PostgreSQL, 13 unit)",
    repoUrl: "https://github.com/gabryelvs/taskboard-api",
    liveUrl: "https://taskboard-api-h3yu.onrender.com/swagger-ui.html",
    liveLabel: "API docs",
    commit: "c8a378693763e984e2b5e3689e026b6b1177f30d",

...
<Evidence path="backend/app/routers/capture.py" lines="16-17">the 1 MB body cap and 500-request limit</Evidence>
</Claim>
...
<Evidence path="backend/app/platform_headers.py" lines="27-34">platform-added headers removed on Vercel only</Evidence>
</Claim>
...
<Evidence path="backend/app/routers/capture.py" lines="29-64">the capture route: 404 for unknown bins, 200 for everything else</Evidence>
</Claim>
...
<Evidence path="backend/app/routers/capture.py" lines="52">content type truncated to the column width</Evidence>
</Claim>
...
<Evidence path="backend/app/routers/capture.py" lines="33-43">the stream loop with its 1 MB cap</Evidence>
</Claim>
...
<Evidence path="backend/app/db.py" lines="47-94">startup waits for the database instead of crashing</Evidence>
</Claim>

<Claim>
Tests cover both the recovery and the give-up path.

<Evidence path="backend/tests/test_db.py" lines="87-106">test_init_db_retries_until_db_ready and test_init_db_raises_after_exhausted_retries</Evidence>
</Claim>
...
<Evidence path="backend/app/client_ip.py" lines="15-51">one client-IP rule for capture and the rate limiter</Evidence>
</Claim>
...
- [Source at the commit this page describes](https://github.com/gabryelvs/webhook-inspector/tree/48e5aec92726cce021ae3b46225bf1f1d8dfb087)
- [The rate-limit test](https://github.com/gabryelvs/webhook-inspector/blob/48e5aec92726cce021ae3b46225bf1f1d8dfb087/backend/tests/test_ratelimit.py#L10-L22)

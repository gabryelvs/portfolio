...
<Evidence path="app/services/ledger.py" lines="11-16">assert_balanced() rejects entries that don't sum to zero</Evidence>
</Claim>
...
<Evidence path="migrations/versions/0045bb75cb4a_initial_schema.py">the initial schema: seven tables</Evidence>
</Claim>
...
<Evidence path="tests/integration/test_concurrent_transfers.py" lines="20-52">test_no_lost_updates_under_concurrency</Evidence>
</Claim>
...
<Evidence path="tests/services/test_transfer_service.py" lines="51-62">test_locked_balance_is_fresh_even_if_the_wallet_was_loaded_earlier</Evidence>
</Claim>
...
<Evidence path="tests/integration/test_concurrent_idempotency.py" lines="51-95">test_parallel_retries_with_one_key_transfer_exactly_once</Evidence>
</Claim>
...
<Evidence path="tests/routers/test_ownership.py" lines="69-77">test_cannot_transfer_from_another_users_wallet</Evidence>
</Claim>
...
The last two were found by an independent review of the fixes above. <Claim>
...
<Evidence path=".github/workflows/ci.yml">ruff and pytest against a PostgreSQL 16 service</Evidence>
</Claim>
...
- [The concurrency test](https://github.com/gabryelvs/payledger/blob/ebb1a8a16770513562010f2ec9de9031bf22037f/tests/integration/test_concurrent_transfers.py#L20-L52)

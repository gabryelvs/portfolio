...
A last review before launch found four real problems, and each was fixed with a test:
...
- **The delete race.** A card deleted in the middle of someone else's move caused a 500. It now maps to a 404, and a constraint violation maps to a 409.
